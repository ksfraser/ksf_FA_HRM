 ...
 * `HRM` token in the namespace below with your module's name, e.g.
 * for ksf_FA_HRM:
 *
 ...
 *  - Each module that DOES rename HRM gets its own class in its own
 ...
 *  - If you FORGET to replace HRM, every unrenamed copy collapses onto
 *    the same placeholder namespace `ksfraser\FrontAccounting\HRM\Utils`;
