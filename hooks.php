...
class hooks_ksf_FA_HRM extends hooks {
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_HRM] = _("");
        $security_areas['SA_ksf_FA_HRMVIEW'] = array(SS_ksf_FA_HRM | 1, _("View "));
        $security_areas['SA_ksf_FA_HRMMANAGE'] = array(SS_ksf_FA_HRM | 2, _("Manage "));
